...
abstract class SuperBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    final override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if (animateStatusBar()) {
            return SuperBottomSheetDialog(this.context!!, R.style.superBottomSheetDialog, maxHeight)
        }

        return SuperBottomSheetDialog(this.context!!, maxHeight)
    }
    ...
    @Dimension
    open fun getMaxHeight(): Int = with(context!!.getAttrId(R.attr.superBottomSheet_maxHeight)) {
        val peekHeightMin = when (this) {
